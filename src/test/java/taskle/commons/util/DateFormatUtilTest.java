...
public class DateFormatUtilTest {
    ...
    @Test
    public void formatDate_dateWithTime_returnStringWithTime(){
    ...
    @Test
    public void formatDate_dateWithoutTime_returnStringWithoutTime(){
    ...
    @Test
    public void formatEventDate_sameDayDifferentTime_returnStringWithoutTime(){
    ...
    @Test
    public void formatEventDate_differentDaySameTime_returnStringWithoutTime(){
